...
mixin _$ForgotPasswordState {
 ...
 String get email; String get otp; String get password; String get confirmPassword;@JsonKey(includeFromJson: false, includeToJson: false) Map<ForgotPasswordField, Option<String>> get validationErrors;
...
@override
int get hashCode => Object.hash(runtimeType,email,otp,password,confirmPassword,const DeepCollectionEquality().hash(validationErrors));

@override
String toString() {
  return 'ForgotPasswordState(email: $email, otp: $otp, password: $password, confirmPassword: $confirmPassword, validationErrors: $validationErrors)';
}
...
@useResult
$Res call({
 String email, String otp, String password, String confirmPassword,@JsonKey(includeFromJson: false, includeToJson: false) Map<ForgotPasswordField, Option<String>> validationErrors
});
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? otp = null,Object? password = null,Object? confirmPassword = null,Object? validationErrors = null,}) {
...
as Map<ForgotPasswordField, Option<String>>,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  String otp,  String password,  String confirmPassword, @JsonKey(includeFromJson: false, includeToJson: false)  Map<ForgotPasswordField, Option<String>> validationErrors)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.email,_that.otp,_that.password,_that.confirmPassword,_that.validationErrors);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  String otp,  String password,  String confirmPassword, @JsonKey(includeFromJson: false, includeToJson: false)  Map<ForgotPasswordField, Option<String>> validationErrors)  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState():
return $default(_that.email,_that.otp,_that.password,_that.confirmPassword,_that.validationErrors);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  String otp,  String password,  String confirmPassword, @JsonKey(includeFromJson: false, includeToJson: false)  Map<ForgotPasswordField, Option<String>> validationErrors)?  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.email,_that.otp,_that.password,_that.confirmPassword,_that.validationErrors);case _:
  return null;
...
class _ForgotPasswordState implements ForgotPasswordState {
  const _ForgotPasswordState({this.email = '', this.otp = '', this.password = '', this.confirmPassword = '', @JsonKey(includeFromJson: false, includeToJson: false) final  Map<ForgotPasswordField, Option<String>> validationErrors = const {ForgotPasswordField.email : None(), ForgotPasswordField.otp : None(), ForgotPasswordField.password : None(), ForgotPasswordField.confirmPassword : None()}}): _validationErrors = validationErrors;
...
@override@JsonKey() final  String confirmPassword;
 final  Map<ForgotPasswordField, Option<String>> _validationErrors;
@override@JsonKey(includeFromJson: false, includeToJson: false) Map<ForgotPasswordField, Option<String>> get validationErrors {
...
@override
int get hashCode => Object.hash(runtimeType,email,otp,password,confirmPassword,const DeepCollectionEquality().hash(_validationErrors));
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? otp = null,Object? password = null,Object? confirmPassword = null,Object? validationErrors = null,}) {
